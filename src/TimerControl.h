...
class TimerControl
{
    public:
        ...
        /**
         * @brief Set peripheral timer clock for the HAL timer handle. frq must be highr than 1 MHz.
         * @param frq: is peripheral timer clock frequency. [Hz].
         * @return true if succeeded. frq must be highr than 1 MHz.
         ...
         */
        bool setClockFrequency(uint32_t frq);
